...
The draft lands in the sender's Drafts for review + manual send.
...
SENDER    = os.environ.get("SEGE_SENDER_EMAIL", "ops@togohealth.com")
SIGN_NAME = os.environ.get("SEGE_SENDER_NAME",  "The TogoHealth team")
SIGN_ROLE = os.environ.get("SEGE_SENDER_ROLE",  "Operations")
SIGN_PHONE= os.environ.get("SEGE_SENDER_PHONE", "")
...
def create_draft(service, facility, to_addr):
    body = BODY_TEMPLATE.format(facility=facility, sign_name=SIGN_NAME, sign_role=SIGN_ROLE,
                                sign_phone=(SIGN_PHONE + "\n") if SIGN_PHONE else "", sender=SENDER)
